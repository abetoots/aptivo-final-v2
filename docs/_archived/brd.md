...
> - **Platform Core**: `platform-core-brd.md` - Shared infrastructure
> - **HR Domain**: `hr-domain-addendum.md` - HR-specific requirements
> - **Crypto Domain**: `crypto-domain-addendum.md` - Trading-specific requirements
>
> See `APTIVO_STRATEGY_MULTI_REVIEW.md` for the strategic rationale behind this restructuring.
>
> Archived copy: `docs/_archived/aptivo-brd-v2.md`
