...
- [x] ADD §14 — Security Threat Analysis added with STRIDE-based threat models for 9 attack surfaces
- [x] ADD §14.9 — Residual Risk Register with 9 documented risks, likelihood/impact, phase classification
- [x] ADD §3.2 — Inngest serve endpoint security documented with signing key requirement
- [x] ADD §15 — References updated with OWASP/STRIDE methodology links
- [x] External model sign-off obtained (see THREAT_MODEL_COVERAGE_MULTI_REVIEW.md)
