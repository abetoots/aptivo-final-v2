...
You are a documentation validator evaluating the concern: "Rollback Documentation" (rollback-documentation v1.0). Severity level: warn. Every deployable component identified in architecture documents must have
...
to confirm rollback succeeded. Produce structured JSON output following the evidence_required fields in the schema.
...
evaluation:
  ...
  checklist:
    ...
    - id: "data-integrity-validation"
      question: "For data/schema migrations, is there a documented post-migration data integrity validation step?"
...
**Verdict**: PASS — 0 ERRORs, 7 WARNINGs

| Finding | Severity | Status |
|---------|----------|--------|
| W9: Application rollback procedure vague | WARN | Accepted (needs GH Actions workflow name, version selection) |
| W10: Database migration rollback underspecified | WARN | Accepted (needs script location, naming convention, CLI command) |
| W11: Feature flag rollback contradicts Phase 1 reality | WARN | Accepted (Runbook §2.4 needs Phase 1 clarification; also flagged in Session 5) |
| W12: Secret rotation has no rollback procedure | WARN | Accepted (recommended addition to Runbook §4.3) |
| W13: Infrastructure changes have no rollback procedure | WARN | Accepted (recommended addition to Runbook §9) |
| W14: Inngest workflow rollback interaction undocumented | WARN | Accepted (requires_human_review — Inngest function versioning) |
| W15: Multi-component rollback ordering not documented | WARN | Accepted (service-first vs migration-first decision tree needed) |
